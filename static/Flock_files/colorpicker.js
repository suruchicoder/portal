...
(function(window, document, undefined) {
    ...
    var colorpickerHTMLSnippet = [
        ...
        '</div>',
        '<div data-dojo-attach-point="colorDescriptorContainer" class="color-descriptor-container">',
        '<div data-dojo-attach-point="colorDescriptor" class="color-descriptor">',
        '<div data-dojo-attach-point="colorSymbolContainer" class="color-descriptor-symbol-container">',
        '<div data-dojo-attach-point="colorSymbol" class="color-descriptor-symbol"></div>',
        '</div>',
        '<div data-dojo-attach-point="colorCodeContainer" class="color-descriptor-code-container">',
        '<input data-dojo-attach-point="colorCode" class="color-descriptor-code" type="text">',
        '</div>',
        '<div data-dojo-attach-point="colorHexContainer" class="color-descriptor-hex-container">',
        '<div data-dojo-attach-point="colorHex" class="color-descriptor-hex">hex</div>',
        '</div>',
        '</div>',
        '</div>'
    ...
    if (type == 'SVG') {
        ...
        slide = $('svg', { xmlns: 'http://www.w3.org/2000/svg', version: '1.1', width: '100%', height: '100%' },
                  [
                      ...
                      $('rect', { x: '0', y: '0', width: '100%', height: '100%', fill: 'url(#gradient-hsv)', rx: '50%'})
                  ]
                 );
        ...
        picker = $('svg', { xmlns: 'http://www.w3.org/2000/svg', version: '1.1', width: '100%', height: '100%' },
                   [
                       ...
                       $('rect', { x: '0', y: '0', width: '100%', height: '100%', fill: 'url(#gradient-white)', rx: '3%'}),
                       $('rect', { x: '0', y: '0', width: '100%', height: '100%', fill: 'url(#gradient-black)', rx:'3%'})
                   ]
                  );
        ...
        slide = [
            ...
            '<v:roundrect arcsize="50%" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%" stroked="f" filled="t">',
        ...
        picker = [
            '<DIV style="position: relative; width: 100%; height: 100%">',
            '<v:roundrect arcsize="3%" style="position: absolute; left: -1px; top: -1px; width: 101%; height: 101%" stroked="f" filled="t">',
            '<v:fill type="gradient" method="none" angle="270" color="#FFFFFF" opacity="100%" color2="#CC9A81" o:opacity2="0%"></v:fill>',
            '</v:rect>',
            '<v:roundrect arcsize="3%" style="position: absolute; left: 0px; top: 0px; width: 100%; height: 101%" stroked="f" filled="t">',
